...
public class DoublyLinkedListDequeTest {
    ...
    class ListWithMoreThanOneItemTests {            //PRUEBAS PARA LISTAS CON MÁS ELEMENTOS
        ...
        class DeletingANodeOfAList{         //PRUEBAS PARA CUANDO SE BORREN NODOS DE DICHAS LISTAS
            ...
            void deleteFirst() {            //Al borrar el primero, el tamaño decrementa y el primer nodo será lo que antes era el segundo nodo
                list.append(1);
                list.append(2);
                list.deleteFirst();
                Object obtainedValue = list.first();
    ...
    @Test
    void getTestNormal(){ //Prueba el funcionamiento normal del get()
        list.append(1);
        list.append(2);
    ...
    @Test
    void getListaVacia(){  //Si la lista es vacía, el get() dará error
